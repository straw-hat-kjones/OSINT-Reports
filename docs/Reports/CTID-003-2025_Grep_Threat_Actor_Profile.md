...
Grep's signature initial access technique centers on the exploitation of Atlassian Jira credentials. The actor acquires credentials harvested by infostealer malware families including [LummaStealer](Malware/LummaStealer.md), [Raccoon Stealer](Malware/Raccoon%20Stealer.md), [RedLine Stealer](Malware/RedLine%20Stealer.md), and StealC. These credentials are either purchased from underground marketplaces or obtained through collaboration with infostealer operators.
