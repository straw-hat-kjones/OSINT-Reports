...
- **Threat Actor Usage**: Deployed by ransomware groups including Octo Tempest, Storm-1607, and Storm-1674; used by [UNC5537](Threat%20Actors/UNC5537.md) in Snowflake cloud storage breaches
...
| [Stargazer Goblin](Threat%20Actors/Stargazer%20Goblin.md) | GitHub distribution | Compromised repositories and social engineering |
