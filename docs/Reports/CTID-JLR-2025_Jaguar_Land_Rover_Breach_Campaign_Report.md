...
The 2025 Jaguar Land Rover (JLR) cyberattack represents one of the most damaging cyber incidents in British corporate history, with estimated economic impact exceeding £1.9 billion. The campaign involved **two distinct attack phases**: a March 2025 data breach attributed to [HELLCAT](Threat%20Actors/HELLCAT.md) ransomware group exploiting stolen Atlassian Jira credentials, followed by a catastrophic September 2025 operational shutdown claimed by [Scattered Spider](Threat%20Actors/Scattered%20Spider.md) (operating as "Scattered Lapsus$ Hunters") that halted global vehicle production for over five weeks.
