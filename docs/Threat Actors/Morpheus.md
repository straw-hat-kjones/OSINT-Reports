...
Morpheus maintains lower public visibility than Hellcat, suggesting either a more selective affiliate model or deliberate operational security measures. The transition of affiliated operators to [Scattered Spider](Threat%20Actors/Scattered%20Spider.md) suggests these threat actors will continue adapting tactics while leveraging proven infrastructure and affiliate networks.
...
Morpheus and Hellcat have developed a distinctive attack chain centered on Atlassian Jira exploitation. Rather than traditional CVE exploitation, the groups primarily leverage credentials stolen by commodity infostealer malware ([LummaStealer](Malware/LummaStealer.md), Raccoon, StealC) from employee and contractor devices.
...
- **Stager.woff** → [SliverC2](Malware/SliverC2.md) implant

When CVE exploitation occurs, the groups target [CVE-2024-0012](Vulnerabilities/CVE-2024-0012.md) (Palo Alto PAN-OS authentication bypass) and [CVE-2024-9474](Vulnerabilities/CVE-2024-9474.md) (PAN-OS privilege escalation).
...
|---------|-------------|----------|-------------|
| [CVE-2024-0012](Vulnerabilities/CVE-2024-0012.md) | Palo Alto PAN-OS | 9.8 | Authentication bypass |
| [CVE-2024-9474](Vulnerabilities/CVE-2024-9474.md) | Palo Alto PAN-OS | 7.2 | Privilege escalation |
