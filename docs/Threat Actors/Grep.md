...
> See [CTID-003-2025_Grep_Threat_Actor_Profile](Reports/CTID-003-2025_Grep_Threat_Actor_Profile.md) for the complete threat intelligence report.
...
Unlike Hellcat associates [Rey](Rey.md) and Pryx, Grep's true identity remains unknown. Key observations:
...
- [Hellcat](Hellcat.md) - Parent ransomware group
- [Rey](Rey.md) - Hellcat associate (exposed)
- [Pryx](Pryx.md) - Hellcat leader (exposed)
- [IntelBroker](IntelBroker.md) - BreachForums owner (arrested)
- [SLSH](SLSH.md) - Related alliance
