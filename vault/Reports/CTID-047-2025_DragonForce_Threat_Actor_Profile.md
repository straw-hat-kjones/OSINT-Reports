...
[[Threat Actors/DragonForce]] is a Ransomware-as-a-Service (RaaS) operation that emerged in August 2023 and has evolved into one of the most significant ransomware threats of 2025. Originally associated with a Malaysian hacktivist collective, the group transformed from politically motivated operations to a profit-driven ransomware cartel.
...
**Initial Access** typically occurs through compromised valid accounts obtained via phishing, credential stuffing, or third-party compromise. The UK retail campaign demonstrated supply chain compromise through the TCS managed service provider relationship. DragonForce affiliates also exploit internet-facing vulnerabilities, with documented exploitation of Log4Shell ([[Vulnerabilities/CVE-2021-44228]]), Ivanti Connect Secure vulnerabilities ([[Vulnerabilities/CVE-2023-46805]], [[Vulnerabilities/CVE-2024-21887]]), and SimpleHelp RMM flaws.

**Persistence** is established through [[Malware/SystemBC]] backdoors and abuse of legitimate remote access tools, particularly AnyDesk. Registry modifications and scheduled tasks provide additional persistence mechanisms.

**Privilege Escalation** leverages [[Malware/Mimikatz]] for credential harvesting from LSASS memory, with NTDS.dit extraction enabling domain-wide compromise. Access token manipulation achieves SYSTEM privileges on individual hosts.
...
**Lateral Movement** occurs primarily through RDP and SMB, facilitated by harvested credentials. [[Malware/Cobalt Strike]] beacons enable C2-directed movement, while legitimate RMM tools (SimpleHelp) provide additional capabilities.
