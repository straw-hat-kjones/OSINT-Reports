...
[[Threat Actors/Rey]], whose real-world identity has been unmasked as **Saif AL-Din Khader**, is a 16-year-old Jordanian cybercriminal who serves as the technical operator and public face of [[Threat Actors/Scattered LAPSUS$ Hunters]] (SLSH)—a cybercriminal supergroup comprising elements of [[Threat Actors/Scattered Spider]], [[Threat Actors/LAPSUS$]], and [[Threat Actors/ShinyHunters]]. Despite his young age, Rey has been directly involved in high-profile data breaches affecting major corporations including Schneider Electric, Telefonica, Orange Romania, and numerous Salesforce customers.

Rey's operational role spans multiple criminal functions: administrator of the Hellcat ransomware data leak site, one of three administrators of SLSH's Telegram channel, former administrator of BreachForums, and developer of the [[Malware/ShinySp1d3r]] ransomware-as-a-service platform. His activities represent a significant evolution in the youth-dominated "Com" cybercriminal ecosystem, where teenage threat actors leverage sophisticated social engineering to compromise enterprise targets.
...
WHERE contains(file.outlinks, this.file.link) OR contains(threat_actors, "Rey") OR contains(threat_actors, "Scattered LAPSUS$ Hunters")
SORT created DESC
LIMIT 10
```
