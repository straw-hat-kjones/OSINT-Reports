...
[[Threat Actors/LAPSUS$]] (also tracked as DEV-0537, Strawberry Tempest, Slippy Spider, Group G1004) was a transnational cybercriminal group primarily composed of teenagers aged 16-21 from the United Kingdom and Brazil. Active from mid-2021 through late 2022, the group specialized in large-scale social engineering, data theft, and extortion operations—notably without deploying ransomware.
...
| Tool | Purpose | Notes |
|------|---------|-------|
| [[Malware/Mimikatz]] | Credential dumping | Standard post-exploitation tool |
| [[Malware/Redline Stealer]] | Password harvesting | Information stealer malware |
